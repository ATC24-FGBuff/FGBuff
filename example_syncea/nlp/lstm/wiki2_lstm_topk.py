...
def draw_curve(epoch, time_arr, ppl_arr, ppl_test):
    ...
    comp_type = '/wiki2_lstm_'+str(args.compressor)+'_ef_epoch_'+str(epoch)+'_'+str(args.density).replace(".", "")
    comp = '/wiki2_lstm_'+str(args.compressor)+'_ef_epoch_'+str(epoch)+'_'+str(args.density).replace(".", "")
