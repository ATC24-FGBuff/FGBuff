...
scp /home/user/eurosys23/workspace/ACTopk/actopk_lib/__init__.py  user@n16:/home/user/eurosys23/workspace/ACTopk/actopk_lib/
scp /home/user/eurosys23/workspace/ACTopk/actopk_lib/__init__.py  user@n17:/home/user/eurosys23/workspace/ACTopk/actopk_lib/
scp /home/user/eurosys23/workspace/ACTopk/actopk_lib/__init__.py  user@n18:/home/user/eurosys23/workspace/ACTopk/actopk_lib/
scp /home/user/eurosys23/workspace/ACTopk/actopk_lib/__init__.py  user@n19:/home/user/eurosys23/workspace/ACTopk/actopk_lib/
scp /home/user/eurosys23/workspace/ACTopk/actopk_lib/__init__.py  user@n20:/home/user/eurosys23/workspace/ACTopk/actopk_lib/
scp /home/user/eurosys23/workspace/ACTopk/actopk_lib/__init__.py  user@n21:/home/user/eurosys23/workspace/ACTopk/actopk_lib/
scp /home/user/eurosys23/workspace/ACTopk/actopk_lib/__init__.py  user@n22:/home/user/eurosys23/workspace/ACTopk/actopk_lib/

if [[ $1 == 'train' ]]; then
    echo 'Run training...'
    HOROVOD_CACHE_CAPACITY=0 horovodrun -np 8 -H n15:1,n16:1,n17:1,n18:1,n19:1,n20:1,n21:1,n22:1 python train_actopk.py \
        --cuda \
        --data /home/user/eurosys23/workspace/ACTopk/examples/nlp/transformer/transformer-xl/pytorch/data/wikitext-2 \
        --dataset wt103 \
        --adaptive \
        --n_layer 16 \
        --d_model 410 \
