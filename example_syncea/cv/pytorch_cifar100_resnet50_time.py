...
def draw_curve(epoch):
    ...
    # comp_type = '/cifar100_resnet50_'+str(args.density)+'_ef_epoch_80_'+str(args.compressor)
    # comp = '/cifar100_resnet50_'+str(args.density)+'_ef_epoch_80_'+str(args.compressor)
    ...
    save_dir = '/home/user/mzq/workspaces/project/dear_pytorch/ATC24-FG-MGS/fgmgs_ours/result_train_syncea'

    comp_type = '/cifar100_resnet50_'+str(args.compressor)+'_ef_epoch_'+str(epoch)+'_'+str(args.density).replace(".", "")
    comp = '/cifar100_resnet50_'+str(args.compressor)+'_ef_epoch_'+str(epoch)+'_'+str(args.density).replace(".", "")
