...
def draw_curve(epoch):
    ...
    comp_type = '/cifar100_vgg16_'+str(args.compressor)+'_ef_epoch_'+str(epoch)+'_'+str(args.density).replace(".", "")
    comp = '/cifar100_vgg16_'+str(args.compressor)+'_ef_epoch_'+str(epoch)+'_'+str(args.density).replace(".", "")

    
    # comp_type = '/cifar100_vgg16_'+str(args.density)+'_ef_epoch_80_'+str(args.compressor)
    # comp = '/cifar100_vgg16_'+str(args.density)+'_ef_epoch_80_'+str(args.compressor)
