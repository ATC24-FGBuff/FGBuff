...
# 环境变量设置
# os.environ['HOROVOD_FUSION_THRESHOLD'] = '1024'
...
# 设置合并的阈值大小,default=138365992为VGG-16所有层梯度元素数量的总和
# parser.add_argument('--threshold', type=int, default=138365992, help='Set threshold if mgwfbp is False')
# parser.add_argument('--threshold', type=int, default=671080, help='Set threshold if mgwfbp is False')
parser.add_argument('--threshold', type=int, default=8383659, help='Set threshold if mgwfbp is False')
...
if __name__ == '__main__':
    ...
    # Allgather
    # params = {'compressor': 'imbalancetopk', 'memory': 'residual', 'communicator': 'allreduce','model_named_parameters':model.named_parameters()}
