...
# Training settings
parser = argparse.ArgumentParser(description='PyTorch Imagenet Resnet101',
...
parser.add_argument('--train-dir', default=os.path.expanduser('/data/dataset/cv/imagenet_0908/train'),
                    help='path to training data')
parser.add_argument('--val-dir', default=os.path.expanduser('/data/dataset/cv/imagenet_0908/val'),
...
def draw_curve(epoch):
    ...
    dataset_model = '/imagenet_resnet101'
    date = '0101'    
    
    comp_type = 'imagenet_resnet101_01_ef_epoch_80_topk'
    comp = 'imagenet_resnet101_01_ef_epoch_80_topk'    
    
    figpath = '/home/user/mzq/workspaces/project/dear_pytorch/mgwfbp/result0101' + dataset_model
    datapath = '/home/user/mzq/workspaces/project/dear_pytorch/mgwfbp/result0101' + dataset_model + comp_type
