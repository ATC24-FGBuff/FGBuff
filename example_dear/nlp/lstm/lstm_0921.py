...
# ACTopk
# params = {'compressor': 'actopk_lstm', 'memory': 'residual', 'communicator': 'allgather','model_named_parameters': model.named_parameters()}

# params = {'compressor': 'actopk_lstm', 'memory': 'residual', 'communicator': 'allgather', 'model_named_parameters': model.named_parameters()} 

# params = {'compressor': 'actopk', 'memory': 'residual', 'communicator': 'allgather', 'model_named_parameters': model.named_parameters()} 

# params = {'compressor': 'allchanneltopk', 'memory': 'residual', 'communicator': 'allgather', 'model_named_parameters': model.named_parameters()} 

# params = {'compressor': 'globaltopk', 'memory': 'residual', 'communicator': 'allgather', 'model_named_parameters': model.named_parameters()} 

# params = {'compressor': 'actopkthreshold_lstm', 'memory': 'residual', 'communicator': 'allgather', 'model_named_parameters': model.named_parameters()} 
...
if hvd.rank() == 0:
    ...
    # np.savetxt("./data828/time_gtopk.txt", time_arr)          
    # np.savetxt("./data828/val_gtopk.txt", ppl_arr)          
    # np.savetxt("./data828/test_gtopk.txt", ppl_test)   
         
    # np.savetxt("./data828/time_allchanneltopk.txt", time_arr)          
    # np.savetxt("./data828/val_allchanneltopk.txt", ppl_arr)          
    # np.savetxt("./data828/test_allchanneltopk.txt", ppl_test)  

         
    # np.savetxt("./data93/time_actopk.txt", time_arr)          
    # np.savetxt("./data93/val_actopk.txt", ppl_arr)          
    # np.savetxt("./data93/test_actopk.txt", ppl_test)  
    
    # np.savetxt("./data93/time_baseline.txt", time_arr)          
    # np.savetxt("./data93/val_baseline.txt", ppl_arr)          
    # np.savetxt("./data93/test_baseline.txt", ppl_test)  

    # np.savetxt("./data828/time_gaussiank.txt", time_arr)          
    # np.savetxt("./data828/val_gaussiank.txt", ppl_arr)          
    # np.savetxt("./data828/test_gaussiank.txt", ppl_test)  


         
    # np.savetxt("./data828/time_redsync.txt", time_arr)          
    # np.savetxt("./data828/val_redsync.txt", ppl_arr)          
    # np.savetxt("./data828/test_redsync.txt", ppl_test)  

    # np.savetxt("./data_0828_nohidden/actopk/time_baseline_actopk.txt", time_arr)               
    # np.savetxt("./data_0828_nohidden/actopk/val_ppl_baseline_actopk.txt", ppl_arr)               
    # np.savetxt("./data_0828_nohidden/actopk/test_ppl_baseline_actopk.txt", ppl_test)       


    # np.savetxt("./data_0828_nohidden/allchanneltopk/time_baseline_allchanneltopk.txt", time_arr)               
    # np.savetxt("./data_0828_nohidden/allchanneltopk/val_ppl_baseline_allchanneltopk.txt", ppl_arr)               
    # np.savetxt("./data_0828_nohidden/allchanneltopk/test_ppl_baseline_allchanneltopk.txt", ppl_test)   