...
# Training settings
parser = argparse.ArgumentParser(description='PyTorch Cifar100 + VGG-19 Example',
...
def draw_curve(epoch):
    ...
    dataset_model = '/cifar100_vgg19_design_compare'
    date = '0103'
    ...
    comp_type = '/cifar100_vgg19_'+str(args.density)+'_ef_epoch_80_'+str(args.compressor)
    comp = '/cifar100_vgg19_'+str(args.density)+'_ef_epoch_80_'+str(args.compressor)
