...
HOROVOD_GPU_OPERATIONS=NCCL HOROVOD_CACHE_CAPACITY=0 horovodrun -np 8 -H node15:1,node16:1,node17:1,node18:1,node19:1,node20:1,node21:1,node22:1   python  wiki103_transformer_topk.py  --epochs $max_epochs --density $density --compressor $compressor --threshold $threshold
