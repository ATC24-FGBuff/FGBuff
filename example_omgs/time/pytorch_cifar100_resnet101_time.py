...
import sys
sys.path.append("../..") 
import hv_distributed_optimizer_calculate_time as hvd
...
parser.add_argument('--model-net', default='resnet101',type=str, help='net type')
...
def draw_curve(epoch):
    ...
    dataset_model = '/cifar100_resnet50_design_compare'
    date = '1229'
    ...
    comp_type = '/fc_conv5_split_001_ef_epoch_80'
    comp = '/fc_conv5_split_001_ef_epoch_80'
    
    
    
    # comp_type = '/fc_conv5_merge_001_ef'
    # comp = '/fc_conv5_merge_001_ef'
    
    
    figpath = '/home/user/mzq/workspaces/project/dear_pytorch/ATC24-FG-MGS/fgmgs_ours/result' + dataset_model
    datapath = '/home/user/mzq/workspaces/project/dear_pytorch/ATC24-FG-MGS/fgmgs_ours/result' + dataset_model + comp_type
...
def train(epoch):
    ...
    if hvd.rank() == 0:
        ...
        backward_time= backward_time-topk_time
        ...
        print('backward_time_per_iteration: ', backward_time/total_iterations)
        arr_synchronize_time = optimizer_synchronize_time_array[10:20]
        arr_synchronize=[]
        for sy in arr_synchronize_time:
            arr_synchronize.append(sy[0])
        print('arr_synchronize: ', arr_synchronize)
        print('optimizer_synchronize_time_per_iteration: ', sum(arr_synchronize)/len(arr_synchronize))
        print('compression_time_per_iteration: ', topk_time/total_iterations)
