# scp -r /home/user/mzq/workspaces/project/dear_pytorch/ATC24-FG-MGS/horovod/example/cv/*  user@node15:/home/user/mzq/workspaces/project/dear_pytorch/ATC24-FG-MGS/horovod/example/cv/
...
# HOROVOD_GPU_OPERATIONS=NCCL HOROVOD_CACHE_CAPACITY=0 horovodrun -np 8 -H node15:1,node16:1,node17:1,node18:1,node19:1,node20:1,node21:1,node22:1   python  pytorch_cifar100_resnet50.py  --epochs $max_epochs --density $density --compressor $compressor --threshold $threshold

# HOROVOD_GPU_OPERATIONS=NCCL HOROVOD_CACHE_CAPACITY=0 horovodrun -np 8 -H node15:1,node16:1,node17:1,node18:1,node19:1,node20:1,node21:1,node22:1   python  pytorch_cifar100_resnet50.py  --epochs $max_epochs --density 0.1 --compressor gaussian --threshold $threshold
...
# HOROVOD_GPU_OPERATIONS=NCCL HOROVOD_CACHE_CAPACITY=0 horovodrun -np 8 -H node15:1,node16:1,node17:1,node18:1,node19:1,node20:1,node21:1,node22:1   python  pytorch_cifar100_vgg16.py  --epochs $max_epochs --density 0.01 --compressor gaussiank --threshold $threshold
