...
def draw_curve(epoch):
    ...
    dataset_model = '/imagenet_resnet50_design_compare'
    date = '0103'
    
    # comp_type = '/horovod_noef'
    # comp = '/horovod_noef'
    
    comp_type = '/imagenet_resnet50_'+str(args.density)+'_ef_epoch_80_'+str(args.compressor)
    comp = '/imagenet_resnet50_'+str(args.density)+'_ef_epoch_80_'+str(args.compressor)
