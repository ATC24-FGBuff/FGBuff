...
def draw_curve(epoch):
    ...
    comp = '/horovod_noef'
    figpath = '/home/user/eurosys23/workspace/ACTopk/examples/cv/imbalance/result' + dataset_model
    datapath = '/home/user/eurosys23/workspace/ACTopk/examples/cv/imbalance/result' + dataset_model + comp_type
...
if __name__ == '__main__':
    ...
    params = {'compressor': 'topksavegradient', 'memory': 'none', 'communicator': 'allgather','model_named_parameters':model.named_parameters()}
