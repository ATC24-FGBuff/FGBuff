...
parser.add_argument('--checkpoint-format', default='./pytorch_checkpoints/cifar100_resnet101/checkpoint-{epoch}.pth.tar',
...
def draw_curve(epoch):
    ...
    # dataset_model = '/cifar100_resnet101'
    # date = '1122'
    dataset_model = '/cifar100_resnet101_design_compare'
    date = '0103'
    
    # comp_type = '/horovod_noef'
    # comp = '/horovod_noef'
    
    comp_type = '/cifar100_resnet101_'+str(args.density)+'_ef_epoch_80_'+str(args.compressor)
    comp = '/cifar100_resnet101_'+str(args.density)+'_ef_epoch_80_'+str(args.compressor)
