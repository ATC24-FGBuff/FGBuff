...
# parser.add_argument('--data', type=str, default='/home/user/mzq/workspaces/project/grace/examples/torch/nlp/data/wikitext-103',
...
def draw_curve(epoch, time_arr, ppl_arr, ppl_test):
    ...
    comp_type = '/wiki2_transformer_'+str(args.compressor)+'_ef_epoch_'+str(args.epochs)+'_'+str(args.density).replace('.','')
    comp = '/wiki2_transformer_'+str(args.compressor)+'_ef_epoch_'+str(args.epochs)+'_'+str(args.density).replace('.','')
