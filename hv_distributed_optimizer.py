...
class _DistributedOptimizer(torch.optim.Optimizer):
    ...
    # Gradient Merging of Minimize Wait_Time
    def _generate_groups_with_number_minimize_wait_time(self, number_layers, threshold_buffer_1):
        ...
        sub_buffer =[3, 7, 26, 126]
        # [1,0]<stdout>:204900
        # [1,0]<stdout>:3413504
        # [1,0]<stdout>:11815424
        # [1,0]<stdout>:8271424
        
        sub_buffer =[3, 6, 10, 17, 126]
        # 
        
        
        # greedy gradient merging
        sub_buffer = [3, 2, 3, 9, 12, 6, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2]
        # 438.5496289730072
        
        
        # sub_buffer = [3, 2, 3, 9, 12, 6, 127]
        # 263.7850091457367
        # [1,0]<stdout>:204900
        # [1,0]<stdout>:4096
        # [1,0]<stdout>:1049600
        ...
        # further merge small buffers
        # sub_buffer = [2, 2, 3, 9, 12, 6, 127]
        
        
        # minimize the number of non overlapping buffers
        # sub_buffer = [2, 2, 3, 9, 12, 6, 127]
        
        sub_buffer = [3, 5, 9, 18, 127]
        # 261.3756399154663
        ...
        # fc and conv5 merge
        # sub_buffer = [8, 9, 18, 127]
        
        
        # sub_buffer = [3, 9, 108, 42]
        sub_buffer = [3, 5, 9, 18, 127]
        
        sub_buffer = [3, 2, 3 , 9, 18, 127]
        # sub_buffer =  [3, 5, 68, 36, 50]
        
        sub_buffer = [5, 3 , 9, 18, 127]
        
        sub_buffer = [3, 5, 9, 17, 60, 68]
        
        # sub_buffer = [3, 5, 9, 17, 128]
        # sub_buffer = [10, 15, 25, 28, 28, 28, 28]
        
        # sub_buffer = [3, 5, 9, 17, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 96]
        ...
        # sub_buffer = utils.optimal_gradient_merging_0101(self._sizes, self._model_net_name, density=self._density)
